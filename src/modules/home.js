...
/* Heading Section: Contains multiple functions
scoped within renderMainPage ES6 Module function. */
...
/* About Our Winery (Winery) Section Functions */
    ...
    function createTable3() {
        ...
        tableThree.setAttribute('id', 'tableThree')
...
/* What's New (Pressed) Section Functions */
    ...
    function createTable4() {
        ...
        tableFour.setAttribute('id', 'tableFour')
    ...
    function createTable5() {
        ...
        tableFive.setAttribute('id', 'tableFive')
    ...
    function createTable6() {
        ...
        tableSix.setAttribute('id', 'tableSix')
...
/* Grapevine (CSMBook) Section Functions */
    ...
    function createTable7() {
        ...
        tableSeven.setAttribute('id', 'tableSeven')
    ...
    function createTable8() {
        ...
        tableEight.setAttribute('id', 'tableEight')
    ...
    function createTable9() {
        ...
        tableNine.setAttribute('id', 'tableNine')
...
/* About Our Wines (Vineyards) Section Functions */
    ...
    function createTable10() {
        ...
        tableTen.setAttribute('id', 'tableTen')
    ...
    function createTable11() {
        ...
        tableEleven.setAttribute('id', 'tableEleven')
    ...
    function createTable12() {
        ...
        tableTwelve.setAttribute('id', 'tableTwelve')
...
/* A Palate of Flavors (Flavors) Section Functions */
    ...
    function createTable13() {
        ...
        tableThirteen.setAttribute('id', 'tableThirteen')
        mainTableFive.appendChild(tableThirteen);
    }
    function createTable14() {
        const tableForteen = document.createElement('div');
        tableForteen.textContent = "A Palate of Flavors";
        tableForteen.setAttribute('id', 'tableForteen')
        mainTableFive.appendChild(tableForteen);
    }
    function createTable15() {
        ...
        tableFifteen.setAttribute('id', 'tableFifteen')
    ...
    function createFooter() {
     ...
     function createSourceCitation() {
        const sourceCitation = document.createElement('footer');
        sourceCitation.setAttribute('id', 'sourceCitation')
        sourceCitation.textContent = 'Developed by Mitchell Neale'
        container.appendChild(sourceCitation);
    }
/* Function Calls */
    createH1();createH2();createH3();createTableHead();createMainTableOne();
    ...
    createTable15();createFooter();createSourceCitation();
};
